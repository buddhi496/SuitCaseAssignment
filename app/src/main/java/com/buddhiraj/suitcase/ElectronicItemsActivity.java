...
public class ElectronicItemsActivity extends AppCompatActivity implements DocumentItemAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Your Electronic Items");
        ...
        DatabaseReference itemsRef = database.getReference("Electronic");
        ...
        String category = "Electronic"; // Replace with the actual category name
