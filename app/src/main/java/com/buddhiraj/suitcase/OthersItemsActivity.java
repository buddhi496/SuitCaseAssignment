...
public class OthersItemsActivity extends AppCompatActivity implements ItemAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Your Others Items");
    ...
    private void setupDatabaseListener() {
        DatabaseReference itemsRef = FirebaseDatabase.getInstance().getReference("Others");
